...
class PositionalEmbedding(nn.Module):
    def __init__(self):
        ...
        nn.init.normal_(self.positional_embedddings_map,
                        std=self.cfg.init_range)  # To learn more about this, refer to my blog, link in README.md file
    ...
    def forward(self, x):
        ...
        pos_embeddings = einops.repeat(pos_embeddings, 'seq_len d_model -> batch seq_len d_model',
                                       batch=batch_size)  # batch seq_len d_model
